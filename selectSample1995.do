//selectSample1995.do
//This do file selects observations from the 1995 SCF for later analysis.
//This should be run after makeVariables1995.do

// Before proceeding, count the number of households and records in the sample.
...
//Count the number of remaining households and records.
...
//Drop those who have labor income less than the 1994 Federal poverty line(s) for householders under 65 years old. (See https://www2.census.gov/programs-surveys/cps/tables/time-series/historical-poverty-people/hstpov1.xls)

gen poverty=0
replace poverty=1 if x101==1 & laborincome<7710
replace poverty=1 if x101==2 & laborincome<9976
replace poverty=1 if x101==3 & laborincome<11821
replace poverty=1 if x101==4 & laborincome<15141
replace poverty=1 if x101==5 & laborincome<17900
replace poverty=1 if x101==6 & laborincome<20235
replace poverty=1 if x101==7 & laborincome<22923
replace poverty=1 if x101==8 & laborincome<25427
replace poverty=1 if x101>=9 & laborincome<30300
