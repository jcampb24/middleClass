...
//Drop those who have labor income less than the 1997 Federal poverty line(s) for householders under 65 years old. (See https://www2.census.gov/programs-surveys/cps/tables/time-series/historical-poverty-people/hstpov1.xls)

gen poverty=0
replace poverty=1 if x101==1 & laborincome<8350
replace poverty=1 if x101==2 & laborincome<10805
replace poverty=1 if x101==3 & laborincome<12802
replace poverty=1 if x101==4 & laborincome<16400
replace poverty=1 if x101==5 & laborincome<19380
replace poverty=1 if x101==6 & laborincome<21886
replace poverty=1 if x101==7 & laborincome<24802
replace poverty=1 if x101==8 & laborincome<27593
replace poverty=1 if x101>=9 & laborincome<32566
