//selectSample2001.do
//This do file selects observations from the 2001 SCF for later analysis.
//This should be run after makeVariables2001.do
...
gen poverty=0
replace poverty=1 if x101==1 & laborincome<8959
replace poverty=1 if x101==2 & laborincome<11590
replace poverty=1 if x101==3 & laborincome<13738
replace poverty=1 if x101==4 & laborincome<17603
replace poverty=1 if x101==5 & laborincome<20819
replace poverty=1 if x101==6 & laborincome<23528
replace poverty=1 if x101==7 & laborincome<26754
replace poverty=1 if x101==8 & laborincome<29701
replace poverty=1 if x101>=9 & laborincome<35060
