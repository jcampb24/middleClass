//selectSample2004.do
//This do file selects observations from the 2004 SCF for later analysis.
//This should be run after makeVariables2004.do
...
replace poverty=1 if x101==3 & laborincome<14680
replace poverty=1 if x101==4 & laborincome<18810
replace poverty=1 if x101==5 & laborincome<22245
replace poverty=1 if x101==6 & laborincome<25122
replace poverty=1 if x101==7 & laborincome<28544
replace poverty=1 if x101==8 & laborincome<31589
replace poverty=1 if x101>=9 & laborincome<37656
